...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataset_mode', type=str, default='refine_cloth', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        # Use insta_gan as a default model
        ###############################################
        parser.add_argument('--model', type=str, default='refine_cloth', help='chooses which model to use. insta_gan, cycle_gan, pix2pix, test')
        ###############################################
