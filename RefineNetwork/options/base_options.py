...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='/home/ubuntu/Desktop/data-conversion/RefineNetwork/data/dataset/', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--batch_size', type=int, default=4, help='input batch size')
        # Specify width and height for load and fine sizes
        parser.add_argument('--loadSizeW', type=int, default=512, help='scale images to this size (width)')
        parser.add_argument('--loadSizeH', type=int, default=512, help='scale images to this size (height)')
        parser.add_argument('--fineSizeW', type=int, default=512, help='then crop to this size (width)')
        parser.add_argument('--fineSizeH', type=int, default=512, help='then crop to this size (height)')
        ...
        parser.add_argument('--dataset_mode', type=str, default='andre_ai_white', help='chooses how datasets are loaded. [unaligned | aligned | single]')
        # Use insta_gan as a default model
        ###############################################
        parser.add_argument('--model', type=str, default='andre_ai_white', help='chooses which model to use. insta_gan, cycle_gan, pix2pix, test')
        ###############################################
        ...
        parser.add_argument('--no_dropout', action='store_true', help='no dropout for the generator', default=False)
