...
class RefineClothDataset(BaseDataset):
    @staticmethod
    ...
    def make_data_bundles(self, base_image_path):
        ...
        for base_path in base_image_path:
            ...
            path_bundles.append({
                ...
                'real_image': os.path.join(self.root, 'clothes', 'base', components[-2], components[-1][-8:-4]),
                'real_image_mask': os.path.join(self.root, 'clothes', 'mask', components[-2], components[-1][-8:-4] + '_mask.png'),
                'source_image': os.path.join(self.root, 'clothes', 'base', components[-2], components[-1][0:4]),
    ...
    def __init__(self, opt):
        ...
        self.dir_clothes_images = os.path.join(self.root, 'clothes/hist/')
